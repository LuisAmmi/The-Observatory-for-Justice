...
$(document).ready(function(){
  $('#topolinoicon').click(function(){
    $('#stylepage').attr('href', 'css/home70.css');
      ...
      $("#specialedition").html('<blockquote id="specialtext"><span class="wh">Who</span> do you call <span class="wh">when</span> people <span class="wh">who</span> <span class="finalpart">should protect you are the abusers?</span></blockquote><img id="clarabella" src="./imgs/70/clarabella.png">');
