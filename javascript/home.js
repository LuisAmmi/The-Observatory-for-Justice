...
$(document).ready(function(){
  ...
  $('#dadaicon').click(function(){
    $('#stylepage').attr('href', 'css/homedada.css');
        ...
        $("#quiquoqua").remove();
        $("#styles").html('<h2 id="styles">Styles</h2><img alt="representation of a fork, image extracted from Der Dada magazine, no.3 of 1920, page n.8" id="fork" src="imgs/dada/fork.png"><img alt="representation of a spiral, image extracted from Dada magazine, no.7 of 1920" id="spiral" src="imgs/dada/spiral.png">');
