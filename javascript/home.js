...
$(document).ready(function(){
  $('#topolinoicon').click(function(){
    $('#stylepage').attr('href', 'css/home70.css');
      ...
      $('#containermultimedia').html('<img id="policar"  alt="advertising in Topolino 1970 no. 889" src="./Documentation/topolino/72policar.jpg">');
      $("#specialedition").html('<p class="question" id="specialtext"><span class="wh">Who</span> do you call <span class="wh">when</span> people <span class="wh">who</span> <span class="finalpart">should protect you are the <span id="abusers">abusers</span><span id="questionmark">?</span></span></p>');
  ...
  $('#dadaicon').click(function(){
    $('#stylepage').attr('href', 'css/homedada.css');
        ...
        $("#quiquoqua").remove();
        $("#referencemagazine").html('<div id="referencemagazine"><img alt="representation of a fork, image extracted from Der Dada magazine, no.3 of 1920, page n.8" id="fork" src="imgs/dada/fork.png"><img id="hand" src="imgs/dada/pointingfinger.png"><h3 id="sources">The reference magazine</h3></div>');
        $("#referencemagazine2").html('<div id="referencemagazine2"><img alt="representation of a fork, image extracted from Der Dada magazine, no.3 of 1920, page n.8" id="fork2" src="imgs/dada/fork.png"><img id="hand2" src="imgs/dada/pointingfinger.png"><h3 id="sources">The reference magazine</h3></div>');
        $("#fonts").html('<div id="divfont"><h3 id="fonts">Fonts</h3><img alt="representation of a spiral, image extracted from Dada magazine, no.7 of 1920" id="spiral" src="imgs/dada/spiral.png"></div>')
        $("#fonts2").html('<div id="divfont"><h3 id="fonts2">Fonts</h3><img alt="representation of a spiral, image extracted from Dada magazine, no.7 of 1920" id="spiral2" src="imgs/dada/spiral.png"></div>')
