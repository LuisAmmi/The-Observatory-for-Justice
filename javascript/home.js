...
$(document).ready(function(){
  ...
  $('#dadaicon').click(function(){
    $('#stylepage').attr('href', 'css/homedada.css');
        ...
        $("#referencemagazine2").html('<div id="referencemagazine2"><img alt="representation of a fork, image extracted from Der Dada magazine, n.3 of 1920, page n.8" id="fork" src="imgs/dada/fork.png"><img id="hand" src="imgs/dada/pointingfinger.png"><h3 id="sources">The reference magazine</h3></div>');
        $(".fotodesigner").remove();
